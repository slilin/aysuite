...
$.xheditor=function(textarea,options)
{
	...
	var bodyClass='',skinPath=jsURL+'../images/xheditor_skin/'+_this.settings.skin+'/';
	...
	{
		var jEmot=$('<div class="xhEdtEmot"></div>'),jLine,jItem,c=0,sEmotPath=jsURL+'../images/xheditor_emot/default/';
		jLine=$('<div></div>');
